...
import UpdateAssignmentModal from './AssignementUpdateModal';
import DeleteAssignmentModal from './AssignementDeleteModal';
...
export default function AssignmentCard({ assignment }: AssignmentCardProps) {
  ...
  const { isOpen: isSeeMoreOpen, onOpen: onSeeMoreOpen, onOpenChange: onSeeMoreOpenChange } = useDisclosure();
  ...
  return (
    <div className='mx-auto mb-4 mt-4 flex h-fit w-11/12 flex-col flex-wrap rounded-lg bg-white p-5'>
      ...
      <p className='mt-2 text-justify font-extrabold'>{assignment.description}</p>
        ...
        <div className='flex h-full'>
          <Button
            onClick={(event) => {
              ...
              localStorage.setItem('selectedAssignmentId', assignment._id);
